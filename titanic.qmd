---
title: Data Korban Kapal Titanic
description: Memvisualisasikan Data Korban Kapal Titanic 
date: 10/31/2024
author: Ahmad Farid Hidayat
categories: [Sebaran Data, Kapal Titanic, Visualisasi]
draft: false
show: true
freeze: true
---
...
# 'original_train = train" will create a reference to the train variable (change in 'train' will apply to 'origina;_train')
...
check_call(['dot','-T','png','tree1.dot','-o','tree1.png'])
